            ...
            <div class="movimentacao-container">
                ...
                if($execute && $execute -> num_rows > 0){
                    ...
                    echo '
                        ...
                        <br>
                            <form id="form-ok-geral" style="margin-left: 16em;">
                    ...
                    <div style="display: flex; flex-direction:column; justify-content:center; align-itens:center;">
                                <form id="form-finalizar-solicitacao">
                                    ...
                                    <input type="submit" id="EnviarExpedicao" name="EnviarExpedicao" value="Finalizar processo das solicitações" style="display:block; margin-left:2vw;" class="irparaoperacao">
                                </form>
                            </div>
                    </div>
                    ';
